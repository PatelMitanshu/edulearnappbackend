...
const APP_VERSION_CONFIG = {
  latestVersion: '2.0.0', // Update this when you release a new version
  ...
  minimumSupportedVersion: '2.0.0', // Versions below this will be forced to update
};
...
router.get('/version', async (req, res) => {
  try {
    ...
    res.status(500).json({ 
      ...
      latestVersion: '2.0.0', // Fallback version
      forceUpdate: false,
